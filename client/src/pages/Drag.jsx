  ...
  render() {
    return (
     <>
        ...
        <form method="post" action="?" encType="multipart/form-data" noValidate className="box">
        ...
        <div className="box__success">Done! <a href="#0" className="box__restart" role="button">Upload more?</a></div>
        <div className="box__error">Error! <span />. <a href="#0" className="box__restart" role="button">Try again!</a></div>
      </form>
